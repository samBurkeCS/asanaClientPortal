...
function addTaskCard(task)
{
	...
	html += `<div class="col-sm-4">
				<div class="col-sm-12 bg-light task-card p-3 mb-5 rounded" data-toggle="modal" data-target="#task735595587499755">
					<div class="row">
						<div class="col-sm-12">
								...
								<div class="modal-body">
									<form>
										<div class="form-group">
											...
											<input class="form-control" type="text" id="name" name="name" value="${task.name}">
										</div>
										<div class="form-group">
											<label class="col-form-label" for="notes">Task description:</label>
											<textarea class="form-control" id="notes" name="notes" rows="15">${task.notes}</textarea>
										</div>
									</form>
								</div>
								<div class="modal-footer">
									<button class="btn btn-secondary" type="button" data-dismiss="modal">Close</button>
									<button class="btn btn-primary" type="button" data-dismiss="modal" onclick="updateTask(${task.id})">Update </button>
								</div>
							</div>
						</div>
					</div>
